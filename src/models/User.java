...
public class User implements IParseModel {
    ...
    public User(long idUser, String name, String password, LocalDate dob, String email, String address, String phoneNumber, EGender gender, models.ERole role) {
        this.idUser = idUser;
        this.name = name;
    ...
    public models.ERole getRole() {
        return role;
    }

    public void setRole(models.ERole role) {
        this.role = role;
    }
